...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'diet_plan.create': {
    roles: ['owner'],
    key: 'diet-plan-created',
    tenantPath: ['organization', 'user', 'diet_plan'],
    userPath: [],
  },
  'diet_plan.update': {
    roles: ['owner'],
    key: 'diet-plan-updated',
    tenantPath: ['organization', 'user', 'diet_plan'],
    userPath: [],
  },
  'dietician.delete': {
    roles: ['owner'],
    key: 'dietician-removed',
    tenantPath: ['organization', 'dietician'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['owner', 'dietician'];
