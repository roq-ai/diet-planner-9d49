  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Diet Planner: Personalizing Nutrition for Your Unique Body and Goals. Tailoring the perfect diet plan based on your age, weight, height, gender, and specific weight objectives."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1531928351158-2f736078e0a1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxkaWV0fGVufDB8fHx8MTY5MzQ5OTQyMXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Diet Planner: Personalizing Nutrition for Your Unique Body and Goals. Tailoring the perfect diet plan based on your age, weight, height, gender, and specific weight objectives.`}
            </Text>
            <Box
