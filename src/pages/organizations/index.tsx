...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'dietician.count', 'invitation.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('dietician', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'dietician',
          header: 'Dietician',
          accessorKey: 'dietician',
          cell: ({ row: { original: record } }: any) => record?._count?.dietician,
        }
      : null,
